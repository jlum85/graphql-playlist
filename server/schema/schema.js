...
// dummy data
var books = [
  { name: "Name of the Wind", genre: "Fantasy", id: "1", aurthorId: "1" },
  { name: "The Final Empire", genre: "Fantasy", id: "2", aurthorId: "2" },
  { name: "The Long Earth", genre: "Sci-Fi", id: "3", aurthorId: "3" },
];
  ...
  fields: () => ({
    ...
    author: {
      ...
      resolve(parent, args) {
        ...
        return _.find(authors, { id: parent.aurthorId });
      },
    },
  }),
});
